-- Update get_jobs_visible_to_viewer to support multi-trade filter.
-- trade_filter can be pipe-separated (e.g. 'Plumbing|Electrical|Roofing').
-- Job visibility uses job.trade_category; viewer sees job if their trade matches.
