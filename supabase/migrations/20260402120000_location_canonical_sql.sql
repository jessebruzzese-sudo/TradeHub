-- Align SQL with canonical user coordinates: location_lat/location_lng and optional search_lat/search_lng.
-- Drops reliance on base_lat/base_lng for job visibility and base_suburb for profile strength completeness.
...
BEGIN
  ...
  IF u.location IS NOT NULL AND trim(u.location) <> '' THEN comp := comp + 2; END IF;
