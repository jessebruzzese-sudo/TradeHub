-- Replace public.calculate_profile_strength with schema-aligned scoring (activity, links, completeness, ABN).
-- Duplicate short + *_points keys and google/likes zeros keep refresh_profile_strength + API parser compatible.
...
begin
  ...
  -- ABN (abn_status is enum — compare via text)
