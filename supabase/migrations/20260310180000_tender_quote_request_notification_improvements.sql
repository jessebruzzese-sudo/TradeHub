-- Improve tender quote request notification: include requester name and tender title
-- Notification badge and Accept->Messages redirect are handled in app code
...
BEGIN
  ...
  SELECT t.builder_id, t.is_anonymous, t.project_name
  INTO v_builder, v_is_anonymous, v_tender_title
