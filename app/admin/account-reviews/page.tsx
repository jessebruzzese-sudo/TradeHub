...
import { AlertCircle, CheckCircle, Flag, User, Mail, Briefcase, MapPin, Calendar, Shield } from 'lucide-react';
...
export default function AccountReviewsPage() {
  ...
  const [action, setAction] = useState<'reviewed' | 'flagged' | 'suspended'>('reviewed');
            ...
            <Card key={review.id} className="p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Created {format(new Date(review.user.created_at), 'MMM d, yyyy')}
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  {review.user.role} - {review.user.primary_trade || 'No trade set'}
                </div>
                ...
                {review.user.location && (
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    {review.user.location}{review.user.postcode ? `, ${review.user.postcode}` : ''}
                  </div>
                )}
              </div>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  asChild
                >
                  <Link href={`/admin/users/${review.user_id}`}>
                    View Full Profile
                  </Link>
                </Button>
      ...
      <Dialog open={showActionDialog} onOpenChange={setShowActionDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Take action on {selectedReview?.user.name}'s account
            </DialogDescription>
          </DialogHeader>
