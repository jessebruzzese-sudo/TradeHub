...
export function JobCard({ job, showStatus = true, extraActions }: JobCardProps) {
  ...
  return (
    <Link href={`/jobs/${job.id}`}>
      <div className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md active:shadow-sm transition-shadow md:flex md:items-center md:gap-6 md:min-h-0 min-h-[160px]">
