        ...
        <main className="relative overflow-hidden bg-transparent">
          ...
          <div className="relative">
            ...
            <section className="relative mx-auto max-w-6xl px-4 py-12 mt-10 md:mt-14">
              ...
              <div className="mt-8 w-full max-w-md mx-auto flex flex-col items-center gap-3">
                <Button
                  asChild
                ...
                <Button
                  asChild
                  variant="outline"
                  className="w-full rounded-xl min-h-[56px] text-base font-semibold bg-white border-slate-300 text-slate-900 hover:bg-slate-50"
                >
                  <Link href="/">
                    Back to home
                  </Link>
