-- Hardened calculate_profile_strength: enum-safe ABN, activity coalesce order, service_role grant.
-- DROP required when renaming the uuid parameter (42P13: cannot change name of input parameter).
...
begin
  ...
  -- ACTIVITY (fixed column order; no new columns)
  ...
  -- ABN: never coalesce enum with ''; compare only via text
