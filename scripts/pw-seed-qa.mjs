...
async function ensureUser(acc) {
  ...
  const userMetadata = {
    ...
    locationLat: acc.location_lat ?? null,
    locationLng: acc.location_lng ?? null,
    location_lat: acc.location_lat ?? null,
    location_lng: acc.location_lng ?? null,
  };
  ...
  const { error } = await admin.from('users').upsert(
    {
      ...
      location_lat: acc.location_lat,
      location_lng: acc.location_lng,
