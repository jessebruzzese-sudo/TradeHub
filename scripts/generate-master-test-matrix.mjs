...
const sectionStatuses = new Map([
  ...
  ['15) Reviews and Ratings', 'MANUAL-GAP'],
  ['16) Notifications', 'CONFIRMED (partial)'],
  ['17) Admin Functionality', 'CONFIRMED (partial)'],
  ['18) Route Guards and Permissions', 'CONFIRMED (partial)'],
  ['19) Supabase / Data Integrity / Guardrails', 'CONFIRMED (partial)'],
  ['20) File Uploads / Storage', 'COVERED-NOT-RUN'],
  ['21) UI/UX Behavior', 'COVERED-NOT-RUN'],
  ['22) Performance / Resilience', 'MANUAL-GAP'],
  ['23) SEO / Marketing Pages', 'COVERED-NOT-RUN'],
  ['24) Security / Abuse Prevention', 'CONFIRMED (partial)'],
  ['25) Cross-Browser / Device Coverage', 'MANUAL-GAP'],
  ['26) Release-Critical End-to-End Journeys', 'CONFIRMED (partial)'],
  ['27) Manual-only or Semi-manual Checks', 'MANUAL-GAP'],
]);
